if vim.b.load_md_plugin then return end
vim.b.load_md_plugin = true
...
local opts = {
  ...
  pipe_table = { alignment_indicator = '─', border = { '╭', '┬', '╮', '├', '┼', '┤', '╰', '┴', '╯', '│', '─' } },
  link = {
...
vim.keymap.set('n', 'gx', open_url, { buffer = true, desc = 'URL opener for markdown' })
